...
public class TypingIndicatorHandler implements MessageHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TypingIndicatorHandler.class);
    ...
    public boolean supports(WebSocketMessage message) {
        return message.getMessageType() == WebSocketMessageType.TYPING_INDICATOR;
    }
    
    @Override
    public String getHandlerName() {
        return "TypingIndicatorHandler";
    }
}
