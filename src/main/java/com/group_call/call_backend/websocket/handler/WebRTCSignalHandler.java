...
@Component
public class WebRTCSignalHandler implements MessageHandler {
    
    private static final Logger logger = LoggerFactory.getLogger(WebRTCSignalHandler.class);
    ...
    public boolean supports(WebSocketMessage message) {
        return message.getMessageType() == WebSocketMessageType.WEBRTC_SIGNAL;
    }
